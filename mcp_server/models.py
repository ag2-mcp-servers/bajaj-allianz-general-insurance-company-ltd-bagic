...
#   timestamp: 2025-06-28T14:52:55+00:00
...
class CertificateParameters(BaseModel):
    ...
    policy_number: str = Field(
        ..., description='Policy Number', examples=['OG-XX-XXXX-XXXX-XXXXXXXX']
    )
...
class CyipcCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class CyipcCertificatePostResponse(BaseModel):
...
class CyipcCertificatePostResponse1(BaseModel):
...
class CyipcCertificatePostResponse2(BaseModel):
...
class CyipcCertificatePostResponse3(BaseModel):
...
class CyipcCertificatePostResponse4(BaseModel):
...
class CyipcCertificatePostResponse5(BaseModel):
...
class CyipcCertificatePostResponse6(BaseModel):
