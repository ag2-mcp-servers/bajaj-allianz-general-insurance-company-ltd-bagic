...
from models import (
    ...
    CyipcCertificatePostRequest,
    CyipcCertificatePostResponse,
    CyipcCertificatePostResponse1,
    CyipcCertificatePostResponse2,
    CyipcCertificatePostResponse3,
    CyipcCertificatePostResponse4,
    CyipcCertificatePostResponse5,
    CyipcCertificatePostResponse6,
...
app = MCPProxy(
    ...
    version='3.0.0',
    servers=[{'url': 'https://apisetu.gov.in/bajajallianz/v3'}],
)
...
@app.post(
    '/cyipc/certificate',
    description=""" API to verify Insurance Policy - Cyber. """,
    tags=['insurance_policy_management'],
    security=[
        APIKeyHeader(name="X-APISETU-APIKEY"),
        APIKeyHeader(name="X-APISETU-CLIENTID"),
...
def cyipc(body: CyipcCertificatePostRequest = None):
    """
